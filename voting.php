					...
					<div class="container">
						<div class="hero__wrapper">
							<div class="row">
								<div class="col-lg-10 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-1 ">
									<div class="hero__title_inner"><span class="hero__icon">b</span>
										<h1 class="hero__title">Days to Voting</h1>
										<p class="hero__text">Are you Registered?</p>
									</div>
								</div>
							</div>
							...
							<div class="service-wrapper">
								...
								<!-- service -->
								<div class="service">
									<h2 class="service__title">Voting</h2>
									<p class="service__text">Sed ante nisl, fermentum et facilisis in, maximus sed ipsum. Cras hendrerit feug</p>
								</div><!-- End / service -->
								
								
								<!-- service -->
								<div class="service">
									<h2 class="service__title">Real Time Results</h2>
